            ...
            Section(header: Text("Change Password")) {
                VStack(alignment: .leading, spacing: 0) {
                    HStack {
                        ...
                        Spacer()
                        if showNewPassword {
                            TextField("Optional", text: $newPassword)
                                .multilineTextAlignment(.trailing)
                        } else {
                            SecureField("Optional", text: $newPassword)
                                .multilineTextAlignment(.trailing)
                        }
                ...
                VStack(alignment: .leading, spacing: 0) {
                    HStack {
                        ...
                        if showConfirmPassword {
                            TextField("Optional", text: $confirmPassword)
                                .multilineTextAlignment(.trailing)
                        } else {
                            SecureField("Optional", text: $confirmPassword)
                                .multilineTextAlignment(.trailing)
                        }
